...
LSA:
```{r}
tottdm <- removeSparseTerms(tottdm, sparse = 0.999)
tottdm_tfidf <- weightTfIdf(tottdm)
totlsa <- lsa(tottdm_tfidf, dims = 5)
totlsa_topics <- lsa(tottdm_tfidf, dims = 10)
totlsa_topics$dk[1:100,]
totlsa_topics$dk[25000:25100,]
totlsa_topics$dk[45:45100,]
totlsa_topics$dk[65:65100,]
totlsa_topics$dk[85000:85100,]
